...
Personal portfolio site featuring project case studies, lightweight 3D and shader demos, and bilingual copy (English and Indonesian).
...
- **Projects**: `src/content/projects/{en,id}/<slug>.ts` — copy, tags, media, links. Slugs must align with `projectIds` in `src/content/projects/index.ts`.
